...
/* LCD_DC Registers */
#define CSR_LCD_DC_BASE (CSR_BASE + 0x800L)
#define CSR_LCD_DC_OUT_ADDR (CSR_BASE + 0x800L)
#define CSR_LCD_DC_OUT_SIZE 1

/* LCD_DC Fields */

/* LCD_RESET Registers */
#define CSR_LCD_RESET_BASE (CSR_BASE + 0x1000L)
#define CSR_LCD_RESET_OUT_ADDR (CSR_BASE + 0x1000L)
#define CSR_LCD_RESET_OUT_SIZE 1

/* LCD_RESET Fields */

/* LCD_BLK Registers */
#define CSR_LCD_BLK_BASE (CSR_BASE + 0x1800L)
#define CSR_LCD_BLK_OUT_ADDR (CSR_BASE + 0x1800L)
#define CSR_LCD_BLK_OUT_SIZE 1

/* LCD_BLK Fields */

/* I2C Registers */
#define CSR_I2C_BASE (CSR_BASE + 0x2000L)
#define CSR_I2C_W_ADDR (CSR_BASE + 0x2000L)
#define CSR_I2C_W_SIZE 1
#define CSR_I2C_R_ADDR (CSR_BASE + 0x2004L)
...
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_ADDR (CSR_BASE + 0x4804L)
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_SIZE 1
#define CSR_SPIFLASH_MASTER_CS_ADDR (CSR_BASE + 0x4808L)
#define CSR_SPIFLASH_MASTER_CS_SIZE 1
#define CSR_SPIFLASH_MASTER_PHYCONFIG_ADDR (CSR_BASE + 0x480cL)
#define CSR_SPIFLASH_MASTER_PHYCONFIG_SIZE 1
#define CSR_SPIFLASH_MASTER_RXTX_ADDR (CSR_BASE + 0x4810L)
#define CSR_SPIFLASH_MASTER_RXTX_SIZE 1
#define CSR_SPIFLASH_MASTER_STATUS_ADDR (CSR_BASE + 0x4814L)
...
/* LCD_DC Access Functions */
static inline uint32_t lcd_dc_out_read(void) {
	return csr_read_simple((CSR_BASE + 0x800L));
}
static inline void lcd_dc_out_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x800L));
}

/* LCD_RESET Access Functions */
static inline uint32_t lcd_reset_out_read(void) {
	return csr_read_simple((CSR_BASE + 0x1000L));
}
static inline void lcd_reset_out_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1000L));
}

/* LCD_BLK Access Functions */
static inline uint32_t lcd_blk_out_read(void) {
	return csr_read_simple((CSR_BASE + 0x1800L));
}
static inline void lcd_blk_out_write(uint32_t v) {
